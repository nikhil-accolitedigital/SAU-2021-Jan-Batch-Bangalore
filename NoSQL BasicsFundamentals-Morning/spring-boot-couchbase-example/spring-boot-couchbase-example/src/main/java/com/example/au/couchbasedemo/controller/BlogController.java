...
public class BlogController {
    ...
    public ArrayList<Blogs> getBlogBytag(@PathVariable String tag){
    	
    	ArrayList <Blogs> result = new ArrayList<Blogs>();
    	
    	result.addAll(blogRepository.findByTag1(tag));
    	result.addAll(blogRepository.findByTag2(tag));
