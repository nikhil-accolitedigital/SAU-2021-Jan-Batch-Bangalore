...
//   
	...
	public void draw() {
		System.out.println("PointA x-axis "+getPointA().getX()+" PointA y-axis "+getPointA().getY());
		System.out.println("PointB x-axis "+getPointB().getX()+" PointB y-axis "+getPointB().getY());
		System.out.println("PointC x-axis "+getPointC().getX()+" PointC y-axis "+getPointC().getY());
	}
